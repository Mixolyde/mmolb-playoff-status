...
class CurrentView {
  ...
  CurrentView.fromHash(String hash) {
    ...
    var exp = RegExp(
      r'#activeLeague=([0|1])&activeView=(\w+)&groupBySubLeague=(\w+)',
    );
  ...
  factory CurrentView.fromJson(Map<String, dynamic> json) {
    ...
    return CurrentView(
      ...
      groupBySubLeague: json['groupBySubLeague'] == null
          ? false
  ...
  String toHash() =>
      '#activeLeague=$activeLeague&activeView=${activeView.index}&groupBySubLeague=$groupBySubLeague';

  @override
  String toString() =>
      'League: $activeLeague View: $activeView GroupBySubLeague: $groupBySubLeague';
}
