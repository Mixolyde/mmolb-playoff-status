    ...
    for (var standing in standingList) {
      ...
      for (var i = 0; i < 4; i++) {
        ...
        if (standing.winning[6] == 'E' && i < 4) {
          ...
          standing.post[i] = formatPercent(
            postCounts[standing.id]![i] / numSims,
          );
        }
      }
      ...
      print(
        '$standing Po ${standing.po} Post ${standing.post} Winning ${standing.winning}',
      );
    }
  }
}
